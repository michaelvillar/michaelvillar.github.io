...
(function() {
  var Animation, Animations, Bezier, Dynamic, DynamicElement, EaseInOut, Gravity, GravityWithForce, Linear, Loop, Matrix, SelfSpring, Spring, Tween, Vector, browserSupportPrefixFor, browserSupportTransform, browserSupportWithPrefix, cacheFn, combineVector, convertToMatrix3d, css, decomposeMatrix, defaultForProperty, degProperties, dynamic, getFirstFrame, hasCommonProperties, interpolateMatrix, keysForTransform, lengthVector, matrixToString, normalizeVector, parseFrames, propertiesAtFrame, pxProperties, recomposeMatrix, set, stopAnimationsForEl, transformProperties, transformStringToMatrixString, unitFor,
  ...
  Animation = (function() {
    ...
    function Animation(el, to, options) {
      var animation, key, pos, redraw, _i, _j, _len, _len1, _ref;
      this.el = el;
      this.to = to;
      if (options == null) {
        options = {};
