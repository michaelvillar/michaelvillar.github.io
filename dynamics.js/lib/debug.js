...
(function() {
  ...
  UIPanel = (function() {
    ...
    UIPanel.prototype.updateOptions = function() {
      var config, e, property, slider, uiProperty, values, _i, _len, _ref, _ref1, _ref2, _results;
    ...
    UIPanel.prototype.makeDraggable = function(el) {
      ...
      initialPos = null;
      initialTopLeft = null;
      _windowMouseMove = (function(_this) {
        return function(e) {
          var pos;
          pos = {
            x: e.pageX,
